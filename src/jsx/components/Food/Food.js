                      ...
                      <tr style={{ textAlign: "center" }}>
                        ...
                        <td>
                          ...
                          <Button
                            ...
                            onClick={() =>
                              navigate("/edit-blog", { state: { id: item.id } })
                            }
                          >
                            <BiSolidEdit />
                          </Button>
                          <Button className="me-2" variant="dark btn-icon-xxs">
                            <FaDownload />
                          </Button>
                          <Button
                          ...
                          <Button className="" variant="secondary btn-icon-xxs" onClick={() => moveToTrash(item.id)}>
                            <FaTrash />
                          </Button>
                        </td>
                      </tr>
